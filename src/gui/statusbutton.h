...
#ifndef __LWQQ_STATUS_BUTTON
#define __LWQQ_STATUS_BUTTON
 ...
 */
#define QQ_STATUSBUTTON(obj)                                            \
    G_TYPE_CHECK_INSTANCE_CAST(obj, qq_statusbutton_get_type(), QQStatusButton)
#define QQ_STATUSBUTTONCLASS(c)                                         \
    G_TYPE_CHECK_CLASS_CAST(c, qq_statusbutton_get_type(), QQStatusButtonClass)
#define QQ_IS_STATUSBUTTON(obj)                                 \
	G_TYPE_CHECK_INSTANCE_TYPE(obj, qq_statusbutton_get_type())
...
// Set the status
//
void qq_statusbutton_set_status_string(GtkWidget *btn, const gchar *status);
void qq_statusbutton_set_status(GtkWidget *btn, QQStatusButtonStatus status);
#endif
