...
static void qq_chatwidget_init(QQChatWidget *widget)
{
    ...
    // font tools
    priv -> font_tool_box = gtk_box_new(GTK_ORIENTATION_VERTICAL, 5);
    ...
    gchar img_file[256];
    g_snprintf(img_file, sizeof(img_file), "%s/selectfont.png", lwqq_icons_dir);
    img = gtk_image_new_from_file(img_file);
    ...
    g_snprintf(img_file, sizeof(img_file), "%s/selectface.png", lwqq_icons_dir);
    img = gtk_image_new_from_file(img_file);
    ...
    g_snprintf(img_file, sizeof(img_file), "%s/sendfile.png", lwqq_icons_dir);
    img = gtk_image_new_from_file(img_file);
    priv -> sendfile_item = gtk_tool_button_new(img, NULL);
    gtk_toolbar_insert(GTK_TOOLBAR(priv -> tool_bar), priv -> sendfile_item, -1);

    g_snprintf(img_file, sizeof(img_file), "%s/sendpic.png", lwqq_icons_dir);
    img = gtk_image_new_from_file(img_file);
    ...
    g_snprintf(img_file, sizeof(img_file), "%s/clearscreen.png", lwqq_icons_dir);
    img = gtk_image_new_from_file(img_file);
    ...
    g_snprintf(img_file, sizeof(img_file), "%s/showhistory.png", lwqq_icons_dir);
    img = gtk_image_new_from_file(img_file);
